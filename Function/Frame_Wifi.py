...
class Frame_Wifi():
    ...
    def Create_widgets(self):
        def create_top_widgets():
            ...
            ### Create Widgets.
            self.Top_Widgets["Title"] = tk.Label(self.Frame["Top"], text="Wifi Parameters", font=self.Setting["Font"]["Title"], foreground="blue")
    ...
    def Load_WifiData(self):
        ...
        for data in wifi_jsondata["Wifi"]:
    ...
    def Button_EditData(self):
        def edit_itme_wifi(selected_item_value:list=None, new_item_value:list=None):
            try:
                ...
                index_replace_data = all_wifi_data.index(selected_data)
                ...
                all_wifi_data[index_replace_data] = new_value
                JsonDataFunction.Update_jsonFileData(self.Wifi_JsonPath, "Wifi", all_wifi_data)
        ...
        try:
            ...
            wifiedit_frame = tk.Toplevel(self.root)
            wifiedit_frame.transient(self.root)  
            wifiedit_frame.grab_set()        
            wifiedit_frame.protocol("WM_DELETE_WINDOW", wifiedit_frame.destroy)
    ...
    def Button_AddData(self):
        ...
        def add_item_wifi(selected_item_value:list=None, new_item_value:list=None):
            try:
                ### Get original wifi data list.
                all_wifi_data = JsonDataFunction.Get_jsonAllData(self.Wifi_JsonPath)["Wifi"]
                ...
                all_wifi_data.append(add_value)
        ...
        try:
            ...
            wifiadd_frame = tk.Toplevel(self.root)
            wifiadd_frame.transient(self.root)  # 設定為主視窗的
            wifiadd_frame.grab_set()           # 設定為模態視窗
            wifiadd_frame.protocol("WM_DELETE_WINDOW", wifiadd_frame.destroy)
    ...
    def Button_DeleteData(self):
        try:
            ...
            for selected_data in list_selected_data:
                if selected_data in all_wifi_data:
